...
object ListUtil:
   ...
   * @param idx The idx of the item to remove
   * @param src The list to remove it from
   * @return A list with the idx item removed. An exception is thrown
   *   if the idx is out of bounds of the list
   */
